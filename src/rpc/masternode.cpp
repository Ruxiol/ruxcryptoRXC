...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner RuxCrypto address\n"
            "  payee          - Print the masternode payout RuxCrypto address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting RuxCrypto address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "ruxcrypto",               "masternode",             &masternode,             true,  {} },
    { "ruxcrypto",               "masternodelist",         &masternodelist,         true,  {} },
    { "ruxcrypto",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "ruxcrypto",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
