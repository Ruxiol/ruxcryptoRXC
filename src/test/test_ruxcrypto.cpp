...
#define BOOST_TEST_MODULE RuxCrypto Test Suite

#include "test_ruxcrypto.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ruxcrypto_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
