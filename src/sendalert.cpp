...
2. run ruxcryptod with -printalert or -sendalert like this:
   /path/to/ruxcryptod -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.ruxcrypto.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/RuxCrypto Core:0.12.0.58/"));
