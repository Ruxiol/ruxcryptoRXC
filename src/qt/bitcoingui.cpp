...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RuxCrypto address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ruxcrypto: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about RuxCrypto Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RuxCrypto addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RuxCrypto addresses"));
    ...
    openAction->setStatusTip(tr("Open a ruxcrypto: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible RuxCrypto command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RuxCrypto network", "", count));
    } else {
...
{
    QString strTitle = tr("RuxCrypto Core"); // default title
    ...
    // Append title to "RuxCrypto Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
