...
This mechanism has been integrated into Bitcore-Node-RuxCrypto which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ruxcryptopay/insight-api-ruxcrypto#web-socket-api](https://github.com/ruxcryptopay/insight-api-ruxcrypto#web-socket-api)
* API: [https://github.com/ruxcryptopay/insight-api-ruxcrypto#instantsend-transactions](https://github.com/ruxcryptopay/insight-api-ruxcrypto#instantsend-transactions)
