...
This document provides guidelines for internationalization of the RuxCrypto Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ruxcrypto_en.ts` remains unchanged.
