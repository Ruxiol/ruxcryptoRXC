...
Arguments:
    <base_directory> - The base directory of a RuxCrypto Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The RuxCrypto Core developers'
...
Arguments:
    <base_directory> - The base directory of RuxCrypto Core source code repository.
"""
...
Arguments:
    <file> - A source file in the RuxCrypto Core repository.
"""
