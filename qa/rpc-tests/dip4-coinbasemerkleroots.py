...
from test_framework.test_framework import RuxCryptoTestFramework
...
class LLMQCoinbaseCommitmentsTest(RuxCryptoTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as RuxCryptoTestFramework doesn't support this atm)
