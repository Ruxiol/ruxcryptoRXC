    ...
    fCapsLock(false)
{
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ...
            break;
        case UnlockMixing:
            ui->warningLabel->setText(tr("This unlocks the wallet for mixing and staking, but NOT for spending. Coins cannot be sent while it is unlocked this way."));
            ui->passLabel2->hide();
            ui->passEdit2->hide();
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Unlock for mixing and staking only"));
            break;
...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR RXC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
